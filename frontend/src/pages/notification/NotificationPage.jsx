...
const NotificationPage = () => {
	...
	return (
		<>
			<div className='flex-[4_4_0] w-full border-l border-r border-gray-700 min-h-screen'>
				<div className='flex justify-between items-center p-4 border-b border-gray-700'>
					...
					<div className='dropdown '>
						...
						<ul
							tabIndex={0}
							className='dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52 left-0'
						>
							<li>
								<a onClick={(e) => {
									e.preventDefault();
